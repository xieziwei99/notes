...
```sh
docker pull mysql
docker run -d -e MYSQL_ROOT_PASSWORD=cemwovQc5yHkpm -p 3306:3306 mysql
```
...
docker run --name code-in-note -it -v /home/lighthouse/code-in-note:/home/lighthouse/code-in-note -d -p 8080:8080 code-in-note
...
docker logs -f --tail 1000 d71a5e6fc351
